...
* **Sockets** are instances that inherit from the duplex stream class, allowing them to both send and receive data
*  it must have a pair of endpoints to communicate 
